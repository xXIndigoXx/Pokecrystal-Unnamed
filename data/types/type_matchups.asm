TypeMatchups:
	...
	db GRASS,     LIGHT,     SUPER_EFFECTIVE
	...
	db FIGHTING,  SOUND,     NOT_VERY_EFFECTIVE
	...
	db FLYING,    SOUND,     SUPER_EFFECTIVE
	...
	db PSYCHIC,   SOUND,     NOT_VERY_EFFECTIVE
	db PSYCHIC,   LIGHT,     SUPER_EFFECTIVE
	...
	db ROCK,      SOUND,     SUPER_EFFECTIVE
	db ROCK,      LIGHT,     SUPER_EFFECTIVE
	...
	db FAIRY,     SOUND,     NOT_VERY_EFFECTIVE
	db SOUND,     PSYCHIC,   NOT_VERY_EFFECTIVE
	db LIGHT,     BUG,       SUPER_EFFECTIVE
	db LIGHT,     GHOST,     SUPER_EFFECTIVE
	db LIGHT,     DARK,      NO_EFFECT
	db LIGHT,     ICE,       NOT_VERY_EFFECTIVE
	db LIGHT,     PSYCHIC,   NOT_VERY_EFFECTIVE
	db LIGHT,     LIGHT,     NO_EFFECT
	db LIGHT,     GRASS,     NO_EFFECT
